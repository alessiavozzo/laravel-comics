    ...
    <div class="footer-top py-4">
        <div class="container d-flex">
            ...
            <div class="footer-left w-50">
                ...
                <p class="text-white">All Site Content TM and 2020 DC Entertainment, unless otherwise
    ...
    <div class="footer-bottom bg-dark py-4">
        <div class="container d-flex justify-content-between">
            ...
            <div class="socials d-flex gap-3 align-items-center">
                <div class="text text-uppercase text-primary">follow us</div>
